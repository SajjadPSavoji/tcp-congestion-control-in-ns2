...
set idx $argv
set agents {Agent/TCP/Reno Agent/TCP/Vegas Agent/TCP}
set ftr_names {Reno.tr Vegas.tr Tahoe.tr}
set fnm_names {Reno.nam Vegas.nam Tahoe.nam}
set agent [lindex $agents $idx]
set ftr_name [lindex $ftr_names $idx]
set fnm_name [lindex $fnm_names $idx]
